...
Your program should:
1. Ask the user what they learned tody.
...
- Make sure the formate is clean and easy to read when opening the file.
...
rating = int(input("⭐ rate your productivity today (1-5, optional):   ").strip())
