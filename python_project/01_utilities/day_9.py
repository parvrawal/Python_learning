...
#  A variable defined inside a loop (for/while) → still accessible outside the loop, because Python loops don’t create their own scope (unlike some other languages like C++ or Java).
print("\n 🔔 Timer started...")
