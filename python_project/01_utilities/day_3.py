...
3. Ask for the total bill amounr.
4. Calculate each person's share of the bill.
5. Display how much each person owes in clean, readable format.
...
num_pepole = int(input("How many people are there in the group?: "))
names = []
...
share = round(total_bill / num_pepole, 2)
