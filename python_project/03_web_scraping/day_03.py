...
- Save the data to a JSON file: books_data_json
- Handle network errors gracefully


Bonus:
- Track how many books scrapped
...
def scrape_page(url):
    ...
    next_link = soup.select_one("li.next > a")
    href = cast(str, next_link.get("href")) if next_link else None
    next_url = urljoin(url, href) if href else None
