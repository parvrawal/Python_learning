...
INPUT_FILE = input("ENTER THE FILE PATH OF INPUT-FILE").strip() or "nested_data.json"
OUTPUT_FILE = input("ENTER THE FILE PATH OF OUTPUT-FILE").strip() or "flattened_data.json"
