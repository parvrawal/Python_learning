...
Create a Python utility that reads structured data (like you'd get from a API) from a `.json` file and converts it to a CSV file that can be opened in Excel.
