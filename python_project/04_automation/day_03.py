...
Teachers: Folder monitoring, real-time automation, event-driven design
...
class FileMoverHandler(FileSystemEventHandler):
    def on_created(self, event):
        ...
        filepath = cast(str, event.src_path)
        ...
        try:
            ...
            print(f"Successfully moved {move_to} file")
        except:
            print(f"Failed to move {move_to}")
